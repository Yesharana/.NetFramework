<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="BookNookWeb.signup" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="imgs/registration.png" />
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <h3 style= "color: #780fce">User Sign Up</h3>
                                </center>
                            </div>
                        </div>
                        ...
                        <br />
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <center>
                                        <asp:Button class="btn btn-outline-success btn-lg btn-block" ID="Button1" runat="server" Text="Sign Up" OnClick="Button1_Click" />
                                    </center>
